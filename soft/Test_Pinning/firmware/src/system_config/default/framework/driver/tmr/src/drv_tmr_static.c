...
{   
    ...
    /* Select clock source */
    PLIB_TMR_ClockSourceSelect ( TMR_ID_1, TMR_CLOCK_SOURCE_SECONDARY_OSCILLATOR);                
    PLIB_TMR_ClockSourceExternalSyncEnable ( TMR_ID_1 );                    
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_1, 2047);
    /* Setup Interrupt */   
